...
- [GitHub remote](issues/03-github-remote.md): `github.com/fnl/fine-tuning-decoder`, `main` @ `9214c69`. `.gitignore` fixed to `/data/` and `src/data/` committed in `17639f2`.
...
- [Spec](spec.md): written and read, `ready-for-agent`; `CONTEXT.md` gained *Exemplar*/*Engine*. **Map closed** — next: `/implement @.scratch/milestone-2-baselines/spec.md`.
